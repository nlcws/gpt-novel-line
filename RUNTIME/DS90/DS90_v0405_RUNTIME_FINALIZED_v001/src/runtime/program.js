...
import { specialistDispatchModule } from "../modules/specialistDispatch.js";
...
export const MODULES = Object.freeze({
  ...
  SPECIALIST_HANDOFF: specialistHandoffModule,
  SPECIALIST_DISPATCH: specialistDispatchModule
});
...
export const READ_ORDER = Object.freeze([
  ...
  "src/adapters/pkdbHostAdapter.js",
...
export function resolveCoreState(input) {
  return MODULES.CORE.transition(input);
}

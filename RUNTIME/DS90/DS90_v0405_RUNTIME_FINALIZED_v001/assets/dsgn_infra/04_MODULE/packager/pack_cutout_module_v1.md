...
- レイヤーACTIVE実行基準は v28 正本を優先する。v21はv28のLINEAGE_REFERENCEとしてのみ扱う。サンプルZIP由来の `STORY_LAYER_COMMON_DEFINITION_SAMPLE.md` は参考に留め、現行レイヤー本体を置換しない。
...
10. 現行V020のPACK_CUTOUT validationで不足・未読・衝突を検出する

...
ACTIVE_ROUTE: none
SUPERSEDED_BY: 00_MANIFEST/current/DSGN_CURRENT_PACKAGE_LOAD_ORDER_v1.md
HISTORICAL_SCOPE: 旧仮想ZIP配置の記録。以下を現行読了順として使わない。
...
この旧仮想ZIP記録上の記述であり、現行handoff契約では各話の固定9ファイルを役割別に渡す。

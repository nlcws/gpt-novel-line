...
PURPOSE: DS90 V020へ統合済みの現行パッケージを維持する収束ガード。
...
このパッケージは DS90 V020 本体へ統合済みである。`ALWAYS_READ`とoperation別
required readsがactive境界を定義し、`02_CANON`と`03_REFERENCE`は必要時だけ読む。

...
| 梱包さんが設定値で迷う | packager.lookup.layer<br>layer.preset.packager_balanced<br>source.registry |
| 旧NOM互換監査を明示された | nom.gate.validation<br>nom.reading.actual<br>nom.fixed_layer<br>nom.frozen_table |
| 単話補完が恒久化しそう | backlog.layer<br>embed.character<br>embed.world_axis |
| 設計から執筆へ渡す時に原文の熱・責任線が落ちそう | quality.heat_delivery<br>quality.novel_absolute_principle |
| カードは条件が合っているが別個体で再現しにくい | quality.card_reproducibility<br>quality.heat_delivery |
| 工程責任が設計・執筆・ユーザー間で混線しそう | quality.novel_absolute_principle |
...
| --- | --- |
| 設計さん | source.registry<br>runtime.load.policy<br>quality.novel_absolute_principle<br>quality.heat_delivery<br>layer.axis.embed<br>embed.character<br>embed.world_axis<br>backlog.layer |
...
| 執筆さん | packager.ready.role<br>packager.v2.role<br>packager.frozen.extract |
| 通し番/検査 | packager.crosscheck<br>layer.prose.forbidden<br>layer.closing.unresolved_residue |

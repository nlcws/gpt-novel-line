...
import { WRITE_EXECUTION_ORDER, REQUIRED_PREWRITE_FLAGS, validateCommonPreWriteState } from "./prewrite-common-contract.js";
...
export { WRITE_EXECUTION_ORDER, REQUIRED_PREWRITE_FLAGS };
...
export function evaluateOutputGate({ preWriteResult, activation, output, checks, consumption } = {}) {
  ...
  failures.push(...validateFullPowerPostTextGate({ preWriteResult, gate: checks?.fullPowerWriteLock, bodyText: output?.text ?? "" }));

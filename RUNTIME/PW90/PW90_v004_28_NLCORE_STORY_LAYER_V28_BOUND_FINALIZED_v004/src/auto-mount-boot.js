...
export function evaluateInitialMountBoot(state = {}) {
  ...
  return Object.freeze({
    ...
    nextAction: failures.length === 0 ? "accept explicit WRITE input; INSPECT/REPAIR are not active operations in this runtime" : "report initial mount failure and stop",

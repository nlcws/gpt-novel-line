...
const validIndex = () => ({
  items: [{
    id: "MT-024-001", location: "024/VAR.md#item", shelf: "024",
  ...
  stopTags: [{
    ...
    scope: "MOUNT_TRANSFER", assignedTo: ["MT-024-001"], released: false
  }]
});
...
test("literal transfer preserves current common-operation STOP", () => {
  const input = validInput();
  input.transfer.commonOperationUsedAsContentSource = true;

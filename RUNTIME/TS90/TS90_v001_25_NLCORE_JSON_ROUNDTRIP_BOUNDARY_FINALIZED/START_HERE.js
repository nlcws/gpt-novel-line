...
export {
  TS90_RUNTIME_ACTION_SCHEMA,
  TS90_RUNTIME_SESSION_SCHEMA,
  TS90_RUNTIME_SKILLS,
...
TS90 v001.25 keeps the resumable Skill runtime and v001.24 public-entry hardening, and binds authority-bearing runtime data to one strict JSON round-trip/canonical serialization boundary with explicit structural budgets. Low-level validator PASS is not terminal runtime SUCCESS.
...
- Phase C / Cモード runs after body-side completion to decide the final title from the final body and fixed conditions.
- Phase C does not revise body text, add story facts, or claim unprovided series-wide title rules.
- A-to-C is the normal continuous delivery route when the user asks TS90 to revise readable text through final title. Do not require per-stage "next" unless a STOP condition appears.
- TXTDL delivery separates TS90_FINAL_BODY.txt and TS90_WORK_REPORT.txt. The top of TS90_FINAL_BODY.txt is a title block: provided work title if any, provided part/volume label if any, episode number/target label, then the selected Phase C story title. Title candidates and reasons remain in the work report. Do not output a separate TS90_FINAL_TITLE.txt. On STOP, deliver TS90_STOP_REPORT.txt and do not force a final title.
